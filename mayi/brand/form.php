...
<form method="post" action="action.php">
    <table>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="japanese_name" size="20"
        ...
        <tr>
            ...
            <td>
                <input type="text" name="chinese_name" size="20"
        ...
        <tr>
            ...
            <td>
                <input type="text" name="english_name" size="20"
                       value="<?php echo htmlspecialchars($item['english_name'], ENT_QUOTES, 'UTF-8'); ?>" >
            </td>
        </tr>
