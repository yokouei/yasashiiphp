...
FROM (SELECT DISTINCT state FROM shipping) a
  ...
  LEFT JOIN (
	...
	echo "<table border='1'>\n";
	echo "<tr>\n";
	echo "<th>STATE</th><th>EMS</th><th>EPACK</th><th>SHIP</th>\n";
	echo "</tr>\n";
